          ...
          <section className="animate-step-in relative flex flex-col items-center pt-9">
            <div className="luxe-ring relative rounded-2xl p-1.5">
              <img
                ...
                width={1238}
                height={864}
                className="animate-float w-44 max-w-full rounded-2xl drop-shadow-[0_0_44px_oklch(0.541___0.145/0.65)]"
              />
            </div>
          ...
          <div className="relative mt-8 pe-1 ps-7">
                  ...
                  return (
                    <button
                      ...
                      className={`group flex h-[86px] w-full flex-col items-center justify-center gap-1.5 rounded-2xl border transition-all duration-300 hover:-translate-y-1 ${
                        active
                          ? "luxe-ring border-gold bg-[linear-gradient(180deg,oklch(0.541___0.145/0.28),oklch(0.41___0.145/0.12))] shadow-[0_0_34px_-6px_oklch(0.541___0.145/0.75)]"
                    ...
                    >
                      <span
                        className={`relative flex h-11 w-11 items-center justify-center overflow-hidden rounded-full border transition-all duration-300 ${
                          active
                            ? "animate-reveal border-gold shadow-[0_0_20px_oklch(0.541___0.145/0.75)]"
            ...
            <Step index={5} title="إيداع مبلغ بحد أدنى" complete={states[4]} delay={280}>
              <div className="grid grid-cols-2 gap-3">
                {["300 جنيه", "6 دولار"].map((amount) => (
                  <span
                    key={amount}
                    className="luxe-corners relative rounded-2xl border border-gold/20 bg-[linear-gradient(180deg,oklch(0.22___0.0425/0.6),oklch(0.11___0.0255/0.85))] px-4 py-4 text-center text-base font-extrabold text-gold-soft"
                  >
                    {amount}
                  </span>
                ))}
            ...
            <Step index={6} title="إدخال الـ ID الخاص بك" complete={states[5]} delay={350}>
              <input
                ...
                placeholder="ID"
                dir="ltr"
                className="w-full rounded-2xl border border-gold/25 bg-background/25 px-4 py-3.5 text-center text-lg font-bold tracking-[0.3em] text-foreground outline-none transition-all placeholder:tracking-normal placeholder:text-muted-foreground/60 focus:border-gold focus:shadow-[0_0_26px_-8px_oklch(0.541___0.145/0.9)]"
              />
              {error ? (
    ...
    >
      <span
        className={`absolute -start-7 top-4 flex h-7 w-7 items-center justify-center rounded-full border text-[11px] font-extrabold transition-all duration-500 ${
          complete
            ? "animate-reveal border-gold bg-gold/25 text-gold-soft shadow-[0_0_18px_oklch(0.541___0.145/0.8)]"
      ...
      <div
        className={`luxe-panel luxe-hairline luxe-corners overflow-hidden rounded-3xl p-4 pt-5 transition-all duration-500 ${
          complete ? "border-gold/55 shadow-[0_0_44px_-18px_oklch(0.541___0.145/0.9)]" : ""
        }`}
      >
