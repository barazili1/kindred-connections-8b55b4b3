    ...
    <>
      <main className="relative z-10 flex min-h-screen flex-col items-center justify-center px-8">
        <img
          ...
          width={1238}
          height={864}
          className="w-52 max-w-full rounded-2xl drop-shadow-[0_0_45px_oklch(0.541_0.145_15/0.6)]"
        />
        ...
        <div className="mt-10 w-full max-w-xs">
          <div className="h-2 w-full overflow-hidden rounded-full border border-border bg-transparent">
            <div
              className="h-full rounded-full bg-gradient-to-r from-primary via-accent to-primary shadow-[0_0_18px_oklch(0.541_0.145_15/0.75)] transition-[width] duration-100 ease-linear"
