  ...
  return (
    <>
      <main className="relative z-10 min-h-screen pb-24">
        <div className="pointer-events-none fixed inset-0 -z-10 bg-[radial-gradient(120%_70%_at_50%_-10%,oklch(0.541___0.145/0.24),transparent_65%)]" />
        <div className="pointer-events-none fixed inset-x-0 bottom-0 -z-10 h-64 bg-[radial-gradient(70%_100%_at_50%_100%,oklch(0.64___0.145/0.14),transparent_70%)]" />
        ...
        <div className="mx-auto max-w-md px-4">
          ...
          <section className="animate-rise relative mt-4 overflow-hidden rounded-3xl border border-primary/25 bg-card/30 p-4 backdrop-blur-xl">
            <div className="pointer-events-none absolute inset-0 opacity-[0.14] [background-image:linear-gradient(oklch(0.64___0.145/0.5)_1px,transparent_1px),linear-gradient(90deg,oklch(0.64___0.145/0.5)_1px,transparent_1px)] [background-size:26px_26px]" />
            ...
            <div className="relative mt-5">
              ...
              {!isRowGame && phase === "ready" && (
                <div className="rounded-2xl border border-accent/60 bg-background/25 p-6 text-center shadow-[0_0_50px_-18px_oklch(0.64___0.145/0.9)]">
...
const cellBase =
  "relative flex aspect-square items-center justify-center overflow-hidden rounded-xl border border-gold/20 bg-[linear-gradient(180deg,oklch(0.22___0.0425/0.75),oklch(0.11___0.0255/0.85))] text-lg shadow-[inset_0_1px_0_oklch(1___0/0.1),0_6px_14px_-8px_oklch(0___0/0.9)] transition-all duration-300";
const cellSafe =
  "border-gold bg-[linear-gradient(180deg,oklch(0.64___0.145/0.35),oklch(0.62___0.13/0.25))] text-gold-soft shadow-[0_0_26px_oklch(0.64___0.145/0.55),inset_0_1px_0_oklch(1___0/0.25)]";
      ...
      return (
        <div>
          <div className="luxe-panel p-6 text-center">
            ...
            <p className="mt-1 font-mono text-5xl font-extrabold text-primary drop-shadow-[0_0_22px_oklch(0.541___0.145/0.7)]">
              {prediction.target}
            </p>
          </div>
          <div className="mt-3 grid grid-cols-2 gap-3">
                ...
                <div key={i} className="flex flex-col items-center">
                  <div
                    className={`relative w-full rounded-2xl px-2 pt-2 transition-all duration-500 ${
                      hit ? "drop-shadow-[0_0_26px_oklch(0.656___0.145/0.7)]" : ""
                    }`}
                  >
                    <img
                      src={cupAsset.url}
                  ...
                  <div className="mt-2 flex h-10 items-center justify-center">
                    {hit ? (
                      <img
                        ...
                        width={80}
                        height={80}
                        className="h-9 w-9 animate-[pulse-glow_2s_ease-in-out_infinite] drop-shadow-[0_0_18px_oklch(0.656___0.145/0.8)]"
                      />
                    ) : (
                ...
                >
                  {safe ? (
                    <img
                      ...
                      alt="Diamond"
                      className="animate-reveal absolute inset-0 h-full w-full object-cover drop-shadow-[0_0_10px_oklch(0.64___0.145/0.6)]"
                    />
                  ) : (
              ...
              return (
                <div
                  ...
                  className={`flex aspect-[4/3] flex-col items-center justify-center gap-2 rounded-2xl border transition-all duration-300 ${
                    hit
                      ? "animate-reveal border-gold bg-gold/10 shadow-[0_0_30px_oklch(0.64___0.145/0.5)]"
      ...
      return (
        <div className="space-y-3">
          {prediction.steps.slice(0, revealCount).map((s, i) => (
            <div
              key={i}
              className="flex items-center justify-between gap-3 rounded-2xl border border-gold/50 bg-gold/10 px-4 py-3 shadow-[0_0_26px_oklch(0.64___0.145/0.3)]"
              dir="rtl"
            >
                  ...
                  return (
                    <div
                      ...
                      className={`flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border transition-all duration-300 ${
                        safe
                          ? "border-gold bg-gold/20 shadow-[0_0_20px_oklch(0.64___0.145/0.55)]"
          ...
          {prediction.rows.map((row, r) => {
            ...
            return (
              <div key={r} className={`flex items-center gap-2 ${shown ? "animate-rise" : ""}`}>
                ...
                {cashout && (
                  <span
                    className="shrink-0 rounded-full border border-gold bg-gold/10 px-2 py-1 text-[10px] font-extrabold text-gold shadow-[0_0_18px_oklch(0.64___0.145/0.5)]"
                    dir="rtl"
                  >
                    اسحب الآن
                  </span>
                  ...
                  <div
                    ...
                    className={`flex aspect-square items-center justify-center rounded-xl border text-2xl ${
                      r === prediction.payline - 1
                        ? "border-gold bg-gold/10 shadow-[0_0_24px_oklch(0.64___0.145/0.45)]"
