...
export function CrashGame({ name, image }: { name: string; image: string }) {
  ...
  return (
    <main className="relative z-10 min-h-screen overflow-hidden pb-20">
      <div className="pointer-events-none fixed inset-0 -z-10 bg-[radial-gradient(120%_80%_at_50%_-10%,oklch(0.541___0.145/0.26),transparent_65%)]" />
      <div className="pointer-events-none fixed inset-x-0 bottom-0 -z-10 h-72 bg-[radial-gradient(70%_100%_at_50%_100%,oklch(0.64___0.145/0.16),transparent_70%)]" />
      ...
      <div className="mx-auto flex max-w-md flex-col px-5">
        ...
        <section className="luxe-panel luxe-hairline animate-rise relative mt-4 overflow-hidden p-5">
          <div className="pointer-events-none absolute inset-0 opacity-[0.18] [background-image:linear-gradient(oklch(0.64___0.145/0.5)_1px,transparent_1px),linear-gradient(90deg,oklch(0.64___0.145/0.5)_1px,transparent_1px)] [background-size:26px_26px]" />
          ...
          <div className="relative mx-auto flex h-52 w-52 items-center justify-center">
            ...
            <svg viewBox="0 0 200 200" className="absolute inset-0 h-full w-full -rotate-90">
              ...
              <circle
                ...
                className="text-accent drop-shadow-[0_0_14px_oklch(0.64___0.145/0.9)]"
              />
            </svg>
          ...
          <div className="relative mt-4">
            ...
            >
              ...
              <path
                ...
                strokeWidth="3"
                strokeLinecap="round"
                className="stroke-accent drop-shadow-[0_0_10px_oklch(0.64___0.145/0.9)]"
              />
            </svg>
            <span
              className="absolute h-3 w-3 rounded-full bg-accent shadow-[0_0_12px_oklch(0.64___0.145/0.9)] ring-2 ring-background"
              style={{
