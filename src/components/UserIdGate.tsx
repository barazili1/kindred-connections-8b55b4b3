...
export function UserIdGate({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/25 p-5 backdrop-blur-md">
      <div className="animate-rise w-full max-w-sm rounded-3xl border border-primary/35 bg-[linear-gradient(160deg,oklch(0.16___0.0425/0.95),oklch(0.09___0.0255/0.97))] p-6 text-center shadow-[0_30px_80px_-30px_oklch(0___0/0.9)]">
        {connecting ? (
